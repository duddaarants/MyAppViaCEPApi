        ...
        btnBuscarCep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    lblLogradouro.setText(retorno.toString());
                    lblComplemento.setText(retorno.toString());
                    lblBairro.setText(retorno.toString());
                    lblLocalidade.setText(retorno.toString());
                    lblUF.setText(retorno.toString());
